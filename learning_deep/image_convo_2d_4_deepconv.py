...
class ConvoClassifier(torch.nn.Module):
    def __init__(self, num_channels, kern_d1, kern_d2):
        ...
        self.convo1 = torch.nn.Conv2d(in_channels=num_channels, out_channels=num_channels, kernel_size=(kern_d1, kern_d2), padding='same', padding_mode='zeros', groups=num_channels)
        self.convo2 = torch.nn.Conv2d(in_channels=num_channels, out_channels=1, kernel_size=(1, 1), padding='same', padding_mode='zeros')

        self.net = torch.nn.Sequential(self.convo1, self.convo2)
...
pandas_predicted_values.to_csv("data/image_convo_2d_4_output.csv")
...
predicted_image.save("data/image_convo_2d_4_output.png")
