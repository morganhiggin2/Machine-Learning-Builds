...
class ConvoClassifier(torch.nn.Module):
    def __init__(self, num_channels, kern_d1, kern_d2):
        ...
        self.net = torch.nn.Sequential(self.convo1, torch.nn.ReLU(), self.maxPool2d, self.convo2)
...
pandas_predicted_values.to_csv("data/image_convo_2d_2_output.csv")
...
predicted_image.save("data/image_convo_2d_2_output.png")
